...
export const FieldSidebar: React.FC<FieldSidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 transform border-r border-ui bg-surface p-4 transition-transform lg:static lg:translate-x-0 ${
      ...
      >
        ...
        {/* Usuário */}
        <div className="mt-5 rounded-xl border border-ui bg-surface-card p-3">
          <div className="flex items-center gap-2">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <button
            onClick={onLogout}
            className="flex w-full items-center gap-2 rounded-xl border border-ui px-3 py-2.5 text-xs font-semibold text-muted hover:bg-surface-raised hover:text-primary transition-colors"
          >
