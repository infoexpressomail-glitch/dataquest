          ...
          <div className="flex flex-wrap items-center gap-2.5">
            <div className="relative min-w-[240px]">
              <select
                ...
                className={`w-full text-xs font-semibold px-3 py-2 rounded-lg border appearance-none pr-8 transition-colors ${
                  'bg-surface-raised border-ui text-primary focus:border-brand-500'
                }`}
              >
                {activeSurveys.map((s) => (
            ...
            {canSaveSizing && (
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-bold bg-accent-primary-solid text-on-accent shadow-md shadow-brand-600/30 hover:bg-accent-primary-solid-hover transition-colors"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div
          className={`p-5 rounded-2xl border transition-all ${
            'bg-surface border-accent-primary-soft-border shadow-lg shadow-brand-950/20'
          }`}
        >
              ...
              {[200, 400, 600, 800, 1000, 1500].map((val) => (
                <button
                  ...
                  className={`text-[10px] font-semibold px-2 py-0.5 rounded-md border transition-colors ${
                    metaTotalInput === val
                      ? 'bg-accent-primary-solid text-on-accent border-brand-500'
                        ...
                        <td key={prod} className="px-3 py-2 text-center">
                          <button
                            ...
                            className={`w-full py-1.5 px-2 rounded-lg font-bold text-xs transition-all ${
                              isCurrentCell
                                ? 'bg-accent-primary-solid text-on-accent shadow-md shadow-brand-600/40 ring-2 ring-brand-400'
                                : count <= 5
                                ? 'bg-accent-success-soft text-accent-success hover:bg-accent-success-solid/20 border border-brand-800/30'
                                : count <= 12
