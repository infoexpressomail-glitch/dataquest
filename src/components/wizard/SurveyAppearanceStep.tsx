            ...
            return (
              <button
                ...
                className={`flex items-start gap-3 rounded-2xl border p-4 text-left transition ${
                  active
                    ? 'border-brand-500 bg-accent-primary-soft ring-2 ring-brand-500/25'
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="mt-1.5 w-full rounded-lg border border-ui bg-surface-card px-3.5 py-2 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
                />
              </div>
              <div>
          ...
          <div className="mt-3 grid grid-cols-3 gap-2 sm:grid-cols-5 md:grid-cols-6">
            {IMAGE_LIBRARY.slice(0, 12).map((img) => (
              <button
                ...
                className="overflow-hidden rounded-xl border border-ui hover:ring-2 hover:ring-brand-500/30"
