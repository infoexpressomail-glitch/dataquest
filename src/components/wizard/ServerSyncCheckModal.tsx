    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-overlay-modal backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl rounded-2xl border border-ui bg-surface-card shadow-2xl p-6 sm:p-7 space-y-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl bg-accent-success-solid hover:bg-accent-success-solid-hover px-5 py-2.5 text-xs font-bold text-on-accent transition shadow-lg shadow-blue-500/20"
                >
        ...
        {step === 'uploading' && (
          <div className="py-8 text-center space-y-4">
            <div className="flex justify-center">
              <div className="h-12 w-12 rounded-full border-2 border-accent-success-soft-border border-t-blue-500 animate-spin flex items-center justify-center">
