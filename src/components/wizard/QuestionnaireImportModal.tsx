          ...
          <div className="flex items-center gap-3">
            ...
            {activeStep === 'input' ? (
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-accent-success-solid px-5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-blue-900/40 hover:bg-accent-success-solid-hover transition active:scale-95"
              >
