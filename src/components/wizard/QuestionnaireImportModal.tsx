        ...
        <div className="flex border-b border-ui/80 bg-surface-app px-6 py-2.5 text-xs font-semibold gap-6">
          <button
            ...
            className={`flex items-center gap-2 transition ${
              activeStep === 'input'
                ? 'text-accent-primary font-bold border-b-2 border-brand-500 pb-1'
...
5. Deixe um comentário com sugestões de melhoria:`}
                  rows={14}
                  className="w-full rounded-xl border border-ui bg-surface-app p-4 text-xs font-mono text-primary placeholder-slate-600 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 transition leading-relaxed"
                />
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-ui/80 pb-3 mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          ...
                          className="rounded-lg border border-accent-primary-soft-border bg-surface-app px-3 py-1.5 text-xs font-semibold text-accent-primary focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 cursor-pointer"
                        >
                    ...
                    <div className="mb-3">
                      <input
                        ...
                        className="w-full rounded-lg border border-ui bg-surface-app px-3 py-2 text-xs font-medium text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
                      />
                    </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {activeStep === 'input' ? (
              <button
                type="button"
                onClick={handleParse}
                className="flex items-center gap-1.5 rounded-lg bg-accent-primary-solid px-5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-accent-success-solid px-5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-success-solid-hover transition active:scale-95"
              >
