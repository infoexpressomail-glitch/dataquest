          ...
          <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto justify-end pt-2 sm:pt-0">
            {formData.serverSyncToken ? (
              <button
                ...
                onClick={() => setServerSyncModalOpen(true)}
                className="flex items-center gap-1.5 rounded-xl bg-accent-success-solid hover:bg-accent-success-solid-hover text-on-accent font-bold px-3.5 py-2 text-xs transition shadow-md shadow-brand-600/20"
              >
          ...
          return (
            <button
              ...
              className={`rounded-xl px-4 py-2.5 text-xs font-bold transition-all ${
                isActive
                  ? 'bg-accent-primary-solid text-on-accent shadow-lg shadow-brand-900/40 ring-2 ring-brand-500/30'
          ...
          <div className="mt-6 space-y-6 max-w-3xl">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1.5 w-full rounded-lg border border-ui bg-surface-card px-3.5 py-2 text-xs text-primary placeholder-slate-500 shadow-xs focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
              />
            </div>
                ...
                <div className="mt-4 space-y-4 pl-2">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start gap-2.5 cursor-pointer">
                      <input
                        ...
                        className="mt-1 h-4 w-4 text-accent-primary-solid focus:ring-brand-500"
                      />
                      <div>
                        <span className="text-xs font-bold text-primary">
                          Acesso público
                  ...
                  <div className="pt-2">
                    ...
                    <select
                      ...
                      className="mt-2 w-full rounded-lg border border-ui bg-surface-card px-3.5 py-2 text-xs text-primary shadow-xs focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500"
                    >
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 border-b border-ui pb-2.5">
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          ...
                          className="rounded-lg border border-accent-primary-soft-border bg-surface px-3 py-1.5 text-xs font-bold text-accent-primary focus:border-brand-400 focus:outline-none cursor-pointer"
                        >
            ...
            <div className="mt-8 rounded-xl border border-dashed border-ui bg-surface-card/60 p-5">
              ...
              <div className="mt-3 grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-1 w-full rounded-lg border border-ui bg-surface px-3 py-2 text-xs text-primary shadow-xs focus:border-brand-500 focus:outline-none"
                  >
                    <option value="multipla_escolha">Múltipla Escolha (Opção Única)</option>
                    <option value="multipla_selecao">Múltipla Seleção (Várias Opções)</option>
                    <option value="texto_aberto">Texto Aberto</option>
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl bg-accent-primary-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover disabled:opacity-40 transition-colors"
                >
            ...
            <div className="mt-8 rounded-xl border border-ui bg-surface-card p-5">
              ...
              <div className="mt-4 flex justify-end">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl bg-accent-primary-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
                >
                  <Plus className="h-4 w-4" />
                    ...
                    >
                      ...
                      {q.opcoes ? (
                            ...
                            <button
                              ...
                              className={`rounded-lg px-2.5 py-1 text-xs font-medium transition ${
                                simTestAnswer[q.id] === opt.value
                                  ? 'bg-accent-primary-solid text-on-accent font-bold shadow-sm shadow-brand-900/50'
                                  : 'border border-ui bg-surface text-secondary hover:bg-surface-raised hover:text-primary'
                              }`}
                            >
                              {opt.label}
                        ...
                        <input
                          ...
                          className="mt-2 w-full rounded-lg border border-ui bg-surface px-2.5 py-1 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
                        />
                      )}
                    </div>
                  );
                ...
                return (
                  <div
                    ...
                    className={`flex cursor-pointer items-start justify-between rounded-xl border p-4 transition ${
                      isSelected
                        ? 'border-accent-primary-soft-border bg-accent-primary-soft shadow-sm shadow-brand-950/40'
                  ...
                  >
                    ...
                    <div
                      className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-md border transition-colors ${
                        isSelected
                          ? 'border-brand-600 bg-accent-primary-solid text-on-accent'
        ...
        <div className="flex items-center gap-2">
          ...
          {currentStep < 6 ? (
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-accent-primary-solid px-5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 rounded-xl px-6 py-2.5 text-xs font-bold text-primary shadow-lg active:scale-95 transition-colors ${
                !effectiveOnline
                  ...
                  : formData.serverSyncToken
                  ? 'bg-accent-success-solid shadow-brand-900/40 hover:bg-accent-success-solid-hover'
                  : 'bg-accent-success-solid shadow-brand-900/40 hover:bg-accent-success-solid-hover'
              }`}
            >
              {!effectiveOnline ? (
          ...
          <div className="mt-4 space-y-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-ui bg-surface-card py-2 pl-8 pr-2 text-xs text-primary placeholder-slate-500 shadow-xs focus:border-brand-500 focus:ring-1 focus:ring-brand-500/40 focus:outline-none"
              />
            </div>
            <select
              value={metaLateralFiltro}
              onChange={(e) => setMetaLateralFiltro(e.target.value as typeof metaLateralFiltro)}
              className="w-full rounded-lg border border-ui bg-surface-card px-2.5 py-2 text-xs text-primary shadow-xs focus:border-brand-500 focus:outline-none"
            >
          ...
          <div className="w-full max-w-md rounded-2xl border border-ui bg-surface p-6 shadow-2xl text-center">
            ...
            <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:justify-center">
              ...
              <button
                ...
                className="rounded-xl bg-accent-primary-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
              >
