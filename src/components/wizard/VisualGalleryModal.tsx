    ...
    return (
      <button
        ...
        className={`relative flex flex-col items-center justify-center gap-1.5 rounded-2xl border p-3 transition ${
          isSel ? 'border-brand-500 bg-accent-primary-soft' : 'border-ui bg-surface-card hover:bg-surface-raised'
        }`}
        title={icon.nome}
      >
        <span
    ...
    return (
      <button
        ...
        className={`relative overflow-hidden rounded-2xl border transition ${
          isSel ? 'border-brand-500 ring-2 ring-brand-500/30' : 'border-ui hover:opacity-95'
        }`}
      >
