        ...
        <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-8 py-2 bg-surface-app border border-ui rounded-lg text-xs text-primary placeholder-slate-500 focus:outline-none focus:border-brand-500 transition-colors"
            />
            {searchTerm && (
              <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-2 border-t border-ui/60 text-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="w-full bg-surface-app border border-ui rounded-lg px-2.5 py-1.5 text-xs text-primary focus:outline-none focus:border-brand-500"
            >
