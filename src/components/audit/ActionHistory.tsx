                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                  ...
                  <div className="lg:col-span-4 bg-surface-card p-3 rounded-lg border border-ui/80 space-y-2">
                    ...
                    <div className="flex items-center gap-3 pt-1">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-600 flex items-center justify-center text-xs font-bold text-primary shadow-xs shrink-0">
