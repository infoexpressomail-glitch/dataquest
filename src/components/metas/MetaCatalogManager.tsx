        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          {canManageMetas && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-accent-primary-solid px-4 py-2.5 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-all shrink-0"
            >
