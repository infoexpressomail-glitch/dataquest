            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-2.5 py-2 text-xs text-primary focus:border-brand-500 focus:outline-none"
                >
              ...
              <div>
                ...
                {hasOpcoes ? (
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-2.5 py-2 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
                  />
                )}
              </div>
            </div>
        ...
        <div className="rounded-2xl border border-ui bg-surface p-5 shadow-xl h-fit">
          ...
          <div className="mt-4">
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-ui bg-surface-card px-3.5 py-2.5 text-xs font-bold text-primary focus:border-brand-500 focus:outline-none"
            />
