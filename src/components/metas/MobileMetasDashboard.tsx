      ...
      <div className="bg-gradient-to-b from-[#161822] to-[#0d0e12] px-5 pt-4 pb-4 border-b border-ui/80">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-tr from-blue-600 to-blue-600 text-sm font-black text-primary shadow-md shadow-blue-900/40">
