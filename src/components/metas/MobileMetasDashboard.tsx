    ...
    <div className="flex flex-col h-full bg-surface-app text-primary overflow-y-auto">
            ...
            <div
              ...
              className={`rounded-2xl border p-4 transition-all ${
                progress.isConcluida
                  ...
                  ? 'border-brand-800/50 bg-accent-primary-soft'
      ...
      <div className="sticky bottom-0 z-20 bg-surface-app/95 border-t border-ui/80 p-3.5 backdrop-blur-md">
        <button
          type="button"
          onClick={handleStartCollection}
          className="w-full flex items-center justify-center gap-2 rounded-xl bg-accent-primary-solid py-3 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover active:scale-[0.98] transition-all"
        >
          ...
          {canSimulateOthers && (
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="rounded-xl border border-ui bg-surface-card px-3 py-1.5 text-xs text-primary focus:border-brand-500 focus:outline-none"
              >
                {collaborators
                  .filter((c) => c.ativo)
                  .map((c) => (
