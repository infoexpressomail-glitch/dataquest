        ...
        <div className="flex flex-col gap-3 p-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full rounded-lg border border-ui bg-surface-card py-1.5 pl-8 pr-3 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            <label className="flex items-center gap-2 cursor-pointer text-xs font-semibold text-secondary hover:text-primary select-none">
              <input
                ...
                className="h-4 w-4 rounded border-ui bg-surface-raised text-accent-primary-solid focus:ring-brand-500 focus:ring-offset-surface cursor-pointer"
              />
          ...
          <div className="flex h-[90vh] w-full max-w-3xl flex-col rounded-2xl border border-ui bg-surface p-6 shadow-2xl">
            ...
            <form onSubmit={handleSave} className="flex-1 overflow-y-auto py-4 space-y-5 pr-2">
                ...
                <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-lg border border-ui bg-surface px-3 py-1.5 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-lg border border-ui bg-surface px-3 py-1.5 text-xs text-primary focus:border-brand-500 focus:outline-none"
                    />
                  </div>
              ...
              <div className="flex items-center justify-end gap-2 border-t border-ui pt-3">
                ...
                <button
                  type="submit"
                  className="rounded-lg bg-accent-primary-solid px-5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
                >
                  Salvar Colaborador
                </button>
              </div>
            ...
            <form onSubmit={handleSavePassword} className="mt-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-3 py-2 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
                />
              </div>
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  type="submit"
                  className="rounded-lg bg-accent-primary-solid px-4 py-1.5 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
                >
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-ui bg-surface-card px-3 py-2 text-xs text-primary focus:border-brand-500 focus:outline-none"
                >
                  {profiles.map((p) => (
                    <option key={p.id} value={p.id}>
