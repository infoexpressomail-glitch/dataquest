          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-bold transition ${
                isSelected
                  ? 'bg-accent-primary-solid text-on-accent shadow-lg shadow-brand-900/40 border border-brand-500'
      ...
      <div className="rounded-2xl border border-ui bg-surface p-4 shadow-xl space-y-4">
        ...
        <div className="relative border-t border-ui pt-3">
          ...
          <input
            ...
            className="w-full rounded-lg border border-ui bg-surface-card py-2 pl-9 pr-3 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
          />
        </div>
      </div>
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          className="mt-0.5 h-4 w-4 rounded text-accent-primary-solid focus:ring-brand-500"
                        />
