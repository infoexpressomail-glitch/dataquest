        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-accent-success-solid px-4 py-1.5 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-success-solid-hover transition-colors"
            >
        ...
        <div className="rounded-2xl border border-ui bg-surface p-5 shadow-xl space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-3 py-2 text-sm font-bold text-primary focus:border-brand-500 focus:outline-none"
            />
              ...
              <div key={block.id} className="rounded-2xl border border-ui bg-surface p-5 shadow-xl space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <input
                    ...
                    className="flex-1 min-w-[200px] rounded-lg border border-ui bg-surface-card px-3 py-1.5 text-sm font-bold text-primary focus:border-brand-500 focus:outline-none"
                  />
                ...
                {previewMode ? (
                  ...
                  <textarea
                    ...
                    className="w-full rounded-lg border border-ui bg-surface-card p-3 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none leading-relaxed font-mono"
                  />
                )}
              </div>
            );
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {canManage && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-accent-primary-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-3 py-2 text-xs text-primary focus:border-brand-500 focus:outline-none"
              >
                {surveys.map((s) => (
