      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {hasPermission('pesquisa_criar') && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-accent-primary-solid px-3.5 py-1.5 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 transition hover:bg-accent-primary-solid-hover active:scale-95"
          >
        ...
        <button
          ...
          className={`flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold border transition ${
            syncProgress.isActive
              ? 'bg-accent-primary-soft border-accent-primary-soft-border text-accent-primary animate-pulse shadow-lg shadow-brand-500/10'
              : !effectiveOnline
              ...
              {(['pt', 'en', 'es'] as Language[]).map((lang) => (
                <button
                  ...
                  className={`flex w-full items-center justify-between px-3 py-1.5 text-left text-xs rounded-lg transition-colors ${
                    language === lang
                      ? 'bg-accent-primary-soft font-bold text-accent-primary border border-brand-600/20'
