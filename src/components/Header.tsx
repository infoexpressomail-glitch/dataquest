    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-ui bg-surface-app/90 px-4 backdrop-blur-md transition-colors sm:px-6 lg:px-8">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="relative">
          ...
          >
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-tr from-blue-600 to-blue-400 text-xs font-bold text-primary shadow-md shadow-blue-900/40">
