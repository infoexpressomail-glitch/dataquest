          ...
          {canExport && (
            <>
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-accent-primary-solid px-3.5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
              >
      ...
      <div className="grid grid-cols-1 gap-3 rounded-2xl border border-ui bg-surface p-4 shadow-xl sm:grid-cols-3">
        ...
        <div>
          ...
          <select
            ...
            className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-2.5 py-1.5 text-xs text-primary focus:border-brand-500 focus:outline-none"
          >
        ...
        <div>
          ...
          <div className="relative mt-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-ui bg-surface-card py-1.5 pl-8 pr-2.5 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
            />
          </div>
        </div>
      </div>
            ...
            <div className="flex-1 overflow-y-auto py-4 space-y-4 pr-1">
              ...
              {editingSubmission.respostas.map((resp) => (
                <div key={resp.perguntaId} className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-ui bg-surface-card px-3 py-1.5 text-xs text-primary shadow-xs focus:border-brand-500 focus:outline-none"
                  />
                </div>
              ))}
              ...
              <div className="pt-2">
                ...
                <textarea
                  ...
                  className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-3 py-1.5 text-xs text-primary shadow-xs focus:border-brand-500 focus:outline-none"
                />
              </div>
            </div>
