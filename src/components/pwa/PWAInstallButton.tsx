          ...
          <div className="w-full max-w-sm rounded-2xl border border-ui bg-surface p-6 shadow-2xl">
            ...
            <div className="mt-4 space-y-3.5 text-xs text-secondary">
              ...
              <div className="flex items-center gap-2 pt-2">
                <button
                  onClick={() => setShowIOSGuide(false)}
                  className="w-full rounded-lg bg-accent-primary-solid py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
                >
                  Entendi
                </button>
              </div>
