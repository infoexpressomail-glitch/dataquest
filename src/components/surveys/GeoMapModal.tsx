        ...
        <div className="flex flex-1 flex-col overflow-hidden md:flex-row">
          ...
          <div className="relative flex-1 bg-surface-app p-4">
            ...
            >
              ...
              <circle cx="50%" cy="50%" r="180" fill="none" stroke="#0b4a8f" strokeWidth="1" strokeDasharray="6,6" opacity="0.3" />
              <circle cx="50%" cy="50%" r="90" fill="none" stroke="#0b4a8f" strokeWidth="1" strokeDasharray="4,4" opacity="0.4" />
            </svg>
                  ...
                  >
                    <div
                      className={`relative flex items-center justify-center rounded-full p-2 shadow-lg transition ${
                        isSelected
                          ? 'bg-accent-primary-solid text-on-accent ring-4 ring-brand-400/50 scale-110 shadow-brand-900/50'
