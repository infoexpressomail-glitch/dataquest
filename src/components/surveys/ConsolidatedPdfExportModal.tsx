      ...
      <div className="w-full max-w-2xl rounded-2xl border border-ui bg-surface p-6 shadow-2xl">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-end gap-3 border-t border-ui pt-4">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-accent-primary-solid px-5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover disabled:opacity-50 transition-all active:scale-95"
          >
            {isExporting ? (
              <>
