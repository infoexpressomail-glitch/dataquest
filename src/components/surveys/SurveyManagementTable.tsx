          ...
          {canCreate && (
            <>
              ...
              <button
                ...
                className="flex h-9 items-center gap-1.5 whitespace-nowrap rounded-lg bg-accent-primary-solid px-4 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 transition hover:bg-accent-primary-solid-hover active:scale-95"
              >
      ...
      <div className="flex flex-col justify-between gap-3 border-b border-ui pb-4 sm:flex-row sm:items-center">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full rounded-lg border border-ui bg-surface-card py-2 pl-9 pr-8 text-xs text-primary placeholder-slate-500 shadow-xs focus:border-brand-500 focus:ring-1 focus:ring-brand-500/40 focus:outline-none"
          />
          {searchTerm && (
            <button
              type="button"
      ...
      <div
        className={`flex flex-wrap items-center justify-between gap-3 rounded-xl border px-4 py-2.5 shadow-md transition-colors ${
          selectedSurveyIds.length > 0
            ? 'border-accent-primary/40 bg-surface-raised ring-1 ring-brand-500/20'
