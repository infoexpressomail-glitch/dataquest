        ...
        <div className="mt-6 rounded-xl border border-ui bg-surface-app p-5 text-primary">
              ...
              return (
                <div
                  ...
                  className={`w-1.5 rounded-full transition-all duration-300 ${
                    isPassed
                      ? 'bg-accent-primary-solid shadow-sm shadow-brand-500/50'
                      : 'bg-surface-raised'
                  }`}
                  style={{ height: `${height}%` }}
                />
          ...
          <div className="mt-3 flex items-center justify-center gap-4">
            ...
            <button
              ...
              className="flex h-12 w-12 items-center justify-center rounded-full bg-accent-primary-solid text-on-accent shadow-lg shadow-brand-900/40 transition hover:bg-accent-primary-solid-hover active:scale-95"
            >
