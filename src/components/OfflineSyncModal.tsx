      ...
      <div className="relative w-full max-w-xl rounded-2xl border border-ui bg-surface p-6 shadow-2xl my-6">
        ...
        <div className="mt-5 flex items-center justify-between border-t border-ui pt-3">
          ...
          <button
            ...
            onClick={handleSync}
            className="flex items-center gap-2 rounded-xl bg-accent-primary-solid px-5 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors active:scale-95"
          >
