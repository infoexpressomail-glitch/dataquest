        ...
        <div className="space-y-3 rounded-2xl border border-ui bg-surface p-5 shadow-xl">
          ...
          <div className="flex justify-end pt-3">
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-accent-success-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-blue-900/40 hover:bg-accent-success-solid-hover transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-accent-success-solid"
            >
