    ...
    <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-ui bg-surface p-4 shadow-xl space-y-3">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full max-w-md rounded-lg border border-ui bg-surface-card px-3 py-2 text-xs text-primary placeholder-slate-500 focus:border-brand-500 focus:outline-none"
            />
      ...
      {importType === 'respostas' && (
        <div className="rounded-2xl border border-ui bg-surface p-4 shadow-xl">
          ...
          <select
            ...
            className="mt-1 w-full rounded-lg border border-ui bg-surface-card px-3 py-2 text-xs text-primary focus:border-brand-500 focus:outline-none max-w-md"
          >
            {surveys.map((s) => (
      ...
      <div
        ...
        className={`relative flex flex-col items-center justify-center rounded-2xl border-2 border-dashed p-10 text-center transition ${
          dragActive
            ? 'border-brand-500 bg-accent-primary-soft'
      ...
      >
        ...
        <label className="mt-4 inline-flex cursor-pointer items-center gap-1.5 rounded-lg bg-accent-primary-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors">
        ...
        <div className="space-y-3 rounded-2xl border border-ui bg-surface p-5 shadow-xl">
          ...
          <div className="flex justify-end pt-3">
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-accent-success-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-success-solid-hover transition-colors disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-accent-success-solid"
            >
