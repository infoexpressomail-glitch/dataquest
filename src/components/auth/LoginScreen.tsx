        ...
        <div className="w-full max-w-md space-y-5">
          ...
          <div className="rounded-3xl border border-ui bg-surface p-6 sm:p-8 shadow-2xl backdrop-blur-md">
            <div className="text-center space-y-1.5 mb-6">
              <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-tr from-blue-600 to-blue-500 text-primary shadow-xl shadow-blue-900/40 mb-3">
