          ...
          <form onSubmit={handleVerify} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full text-center tracking-widest font-mono text-base font-bold rounded-lg border border-ui bg-surface-card py-2 text-primary focus:border-brand-500 focus:outline-none"
              />
