      ...
      return (
        <div className="mx-auto my-12 max-w-lg rounded-2xl border border-ui bg-surface p-8 text-center shadow-2xl">
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-1.5 rounded-lg bg-accent-primary-solid px-4 py-2 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:opacity-90 transition-colors"
          >
    ...
    >
      ...
      {isResearcher && (
        <button
          ...
          className="fixed bottom-12 right-4 z-30 inline-flex items-center gap-2 rounded-xl bg-accent-primary-solid px-4 py-2.5 text-xs font-bold text-on-accent shadow-lg shadow-brand-900/40 hover:bg-accent-primary-solid-hover transition-colors"
        >
