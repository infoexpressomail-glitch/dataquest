    ...
    >
      ...
      {isResearcher && (
        <button
          ...
          className="fixed bottom-12 right-4 z-30 inline-flex items-center gap-2 rounded-xl bg-accent-primary-solid px-4 py-2.5 text-xs font-bold text-on-accent shadow-lg shadow-blue-900/40 hover:bg-accent-primary-solid-hover transition-colors"
        >
